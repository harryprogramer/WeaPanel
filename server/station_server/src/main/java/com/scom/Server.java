...
public class Server extends Service {
    ...
    private static final ArrayList<Class<? extends TelemetryStream>> telemetry_streams = new ArrayList<>();
        ...
        synchronized (lock) {
            if (Objects.isNull(sck_server)) {
                try {
                    ...
                    socketCore.registerTelemetryTasks(telemetry_streams);
    ...
    public static void addTelemetryTask(Class<? extends TelemetryStream> task){
        telemetry_streams.add(task);
    }
